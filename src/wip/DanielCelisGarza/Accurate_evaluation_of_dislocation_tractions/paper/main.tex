...
\begin{figure}
    \centering
    \subfloat[$\hat{\sigma}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxAeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxAEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxNeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxNEperp.pdf}}
    }

    \subfloat[$\hat{\sigma}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyAeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyAEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyNeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyNEperp.pdf}}
    }

    \subfloat[$\hat{\sigma}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxyEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyAeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxyAEperp.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyNeperp}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxyNEperp.pdf}}
    }
    \caption{Image stresses for an edge dislocation with $\vec{l} = [0 0 1]$, $\vec{b} = [1 0 0]$, with $a = 10~b$ with coordinates $(26.3158,~ 500)~b$, i.e. the centre of the first FE from the surface at $x=0$, and in the centre of the simulation box from top to bottom. Here $b = \lVert \bm{b} \rVert$.}
    \label{f:head_vs_ana_vs_num_eperp}
\end{figure}

\begin{figure}
    \centering
    \subfloat[$\hat{\sigma}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxAepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxAEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxxNepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxxNEpar.pdf}}
    }

    \subfloat[$\hat{\sigma}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyAepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyAEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syyNepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syyNEpar.pdf}}
    }

    \subfloat[$\hat{\sigma}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxyEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyAepar}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxyAEpar.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{xy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxyNepar}]
    {
...
\begin{figure}
    \centering
    \subfloat[$\hat{\sigma}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxzscrew}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxzscrew.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxzAscrew}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxzAscrew.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{xx}$, $\bm{b}_{\textrm{e1}}$.\label{sf:sxzNscrew}]
    {
    {\includegraphics[width=0.3\linewidth]{images/sxzNscrew.pdf}}
    }

    \subfloat[$\hat{\sigma}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:szyscrew}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syzscrew.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{A}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syzAscrew}]
    {
    {\includegraphics[width=0.3\linewidth]{images/syzAscrew.pdf}}
    }~
    \subfloat[$\hat{\sigma}^\textrm{N}_{yy}$, $\bm{b}_{\textrm{e1}}$.\label{sf:syzNscrew}]
    {
