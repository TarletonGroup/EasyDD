function [f_dln, f_dln_se, f_dln_node] = analytic_traction(tract, gamma, ...
        f_dln, dln_node_coord, burgers, n_dln, MU, NU, a, CUDA_flag)
    %%===================================================================%%
    %---------------------------------------------------------------------%
    ...
    % Auxillary variables defined in AuxFEMCoupler.m
    se_node_coord = tract.x3x6;
    para_tol = tract.para_tol;
    n_se = tract.n_se;
    idxi = tract.idxi;
    n_nodes = tract.n_nodes;
    n_nodes_t = tract.n_nodes_t;
    n_threads = tract.n_threads;
    para_scheme = tract.para_scheme;
    f_dln_node = tract.f_tilda_node;
