...
%             nodal_force, total_force, 
    ...
    %
    %%===================================================================%%
%     size(Stop,1) == (fem_dim(2)+1)*(fem_dim(1)-1)
%     size(Sbot,1) == (fem_dim(2)+1)*(fem_dim(1)-1)
%     size(Sleft,1) == (fem_dim(2)+1)*(fem_dim(3)+1)
%     size(Sright,1) == (fem_dim(2)+1)*(fem_dim(3))
%     size(Sfront,1) == (fem_dim(3)-1)*(fem_dim(1)-1)
%     size(Sback,1) == (fem_dim(3)-1)*(fem_dim(1)-1)
%     size(gammaMixed,1) == fem_dim(2)+1
