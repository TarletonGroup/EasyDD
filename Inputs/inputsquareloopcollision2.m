...
rn=[         6*c   4.5*c+2*x-y           1.5*c   0;
           6*c+x       4.5*c-y         1.5*c+x   0;
         6*c+2*x   4.5*c-2*x-y       1.5*c+2*x   0;
       6*c+2*x+y     4.5*c-2*x     1.5*c+2*x+y   0;
     6*c+2*x+2*y   4.5*c-2*x+y   1.5*c+2*x+2*y   0;
       6*c+x+2*y       4.5*c+y     1.5*c+x+2*y   0;
         6*c+2*y   4.5*c+2*x+y       1.5*c+2*y   0;
           6*c+y     4.5*c+2*x         1.5*c+y   0;
             9*c   5.5*c+2*x-y           1.5*c   0;
           9*c-x       5.5*c-y         1.5*c+x   0;
         9*c-2*x   5.5*c-2*x-y       1.5*c+2*x   0;
       9*c-2*x-y     5.5*c-2*x     1.5*c+2*x+y   0;
     9*c-2*x-2*y   5.5*c-2*x+y   1.5*c+2*x+2*y   0;
       9*c-x-2*y       5.5*c+y     1.5*c+x+2*y   0;
         9*c-2*y   5.5*c+2*x+y       1.5*c+2*y   0;
           9*c-y     5.5*c+2*x         1.5*c+y   0];
