                        ...
                        __float128 *fp8x, __float128 *fp8y, __float128 *fp8z)
{
  ...
  __float128 Lp, Lq, lplq, lqlp, r0, s0;
  ...
  __float128 signv[8];
  __float128 scH0013=0.0q, scH1003=0.0q, scH0103=0.0q, scH2003=0.0q;
  __float128 scH0203=0.0q, scH1013=0.0q, scH0113=0.0q, scH1103=0.0q;
  __float128 scH2013=0.0q, scH0213=0.0q, scH2103=0.0q, scH1203=0.0q;
  __float128 scH3003=0.0q, scH0303=0.0q, scH0015=0.0q, scH1005=0.0q;
  __float128 scH0105=0.0q, scH2005=0.0q, scH0205=0.0q, scH1015=0.0q;
  __float128 scH0115=0.0q, scH1105=0.0q, scH1115=0.0q, scH1125=0.0q;
  __float128 scH2115=0.0q, scH1215=0.0q, scH1025=0.0q, scH0125=0.0q;
  __float128 scH2015=0.0q, scH0215=0.0q, scH2025=0.0q, scH0225=0.0q;
  __float128 scH3015=0.0q, scH0315=0.0q, scH1113=0.0q;
  __float128 scH2105=0.0q,   scH1205=0.0q;
  __float128 scH3005=0.0q,   scH0305=0.0q,   scH2215=0.0q,   scH2125=0.0q;
  __float128 scH1225=0.0q,   scH4015=0.0q,   scH0415=0.0q,   scH3025=0.0q;
  __float128 scH0325=0.0q,   scH3115=0.0q,   scH1315=0.0q;
...
/*
  printf("Rdotp =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", Rdotp[i]); }
  printf("Rdotq =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", Rdotq[i]); }
  printf("rRdott =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", rRdott[i]); }
  printf("sRdott =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", sRdott[i]); }
  printf("RaRdotp =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", RaRdotp[i]); }
  printf("RaRdotq =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", RaRdotq[i]); }
  printf("rRaRdott =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", rRaRdott[i]); }
  printf("sRaRdott =\n");for(i=0;i<8;i++) {quadmath_snprintf(cv8[i], 256,  "%*.30Qf", sRaRdott[i]); }
...
*/
  ...
  //
  for(w=0;w<8;w++) {
    scH0013= scH0013 +H0013[w]*signv[w];
    scH1003= scH1003 +H1003[w]*signv[w];
    scH0103= scH0103 +H0103[w]*signv[w];

    scH2003= scH2003 +H2003[w]*signv[w];
    scH0203= scH0203 +H0203[w]*signv[w];

    scH1013= scH1013 +H1013[w]*signv[w];
    scH0113= scH0113 +H0113[w]*signv[w];
    scH1103= scH1103 +H1103[w]*signv[w];

    scH2013= scH2013 +H2013[w]*signv[w];
    scH0213= scH0213 +H0213[w]*signv[w];
    scH2103= scH2103 +H2103[w]*signv[w];
    scH1203= scH1203 +H1203[w]*signv[w];
    scH1113= scH1113 +H1113[w]*signv[w];
    scH3003= scH3003 +H3003[w]*signv[w];
    scH0303= scH0303 +H0303[w]*signv[w];

    scH0015= scH0015 +H0015[w]*signv[w];
    scH1005= scH1005 +H1005[w]*signv[w];
    scH0105= scH0105 +H0105[w]*signv[w];
    scH2005= scH2005 +H2005[w]*signv[w];
    scH0205= scH0205 +H0205[w]*signv[w];
    scH1015= scH1015 +H1015[w]*signv[w];
    scH0115= scH0115 +H0115[w]*signv[w];
    scH1105= scH1105 +H1105[w]*signv[w];
    scH1115= scH1115 +H1115[w]*signv[w];
    scH1125= scH1125 +H1125[w]*signv[w];
    scH2115= scH2115 +H2115[w]*signv[w];
    scH1215= scH1215 +H1215[w]*signv[w];
    scH1025= scH1025 +H1025[w]*signv[w];
    scH0125= scH0125 +H0125[w]*signv[w];
    scH2015= scH2015 +H2015[w]*signv[w];
    scH0215= scH0215 +H0215[w]*signv[w];
    scH2025= scH2025 +H2025[w]*signv[w];
    scH0225= scH0225 +H0225[w]*signv[w];
    scH3015= scH3015 +H3015[w]*signv[w];
    scH0315= scH0315 +H0315[w]*signv[w];

    scH2105= scH2105 +H2105[w]*signv[w];
    scH1205= scH1205 +H1205[w]*signv[w];
    scH3005= scH3005 +H3005[w]*signv[w];
    scH0305= scH0305 +H0305[w]*signv[w];
    scH2215= scH2215 +H2215[w]*signv[w];
    scH2125= scH2125 +H2125[w]*signv[w];
    scH1225= scH1225 +H1225[w]*signv[w];
    scH4015= scH4015 +H4015[w]*signv[w];
    scH0415= scH0415 +H0415[w]*signv[w];
    scH3025= scH3025 +H3025[w]*signv[w];
    scH0325= scH0325 +H0325[w]*signv[w];
    scH3115= scH3115 +H3115[w]*signv[w];
    scH1315= scH1315 +H1315[w]*signv[w];
  }
/*
  quadmath_snprintf(csca, 256,  "%*.30Qf", scH0013); printf("scH0013 = %s \n\n ", csca);
  printf("scH0013 =\n"); printf("  %Qf \n",scH0013);
  printf("scH1003 =\n"); printf("  %Qf \n",scH1003);
  printf("scH0103 =\n"); printf("  %Qf \n",scH0103);
...
*/
  ...
  F0013=AA*scH2013+BB*scH1013+CC*scH0013;
  F0103=AA*scH2103+BB*scH1103+CC*scH0103;
  F1003=AA*scH3003+BB*scH2003+CC*scH1003;

  F0015=AA*scH2015+BB*scH1015+CC*scH0015;
  F0105=AA*scH2105+BB*scH1105+CC*scH0105;
  F1005=AA*scH3005+BB*scH2005+CC*scH1005;

  F0215=AA*scH2215+BB*scH1215+CC*scH0215;
  F2015=AA*scH4015+BB*scH3015+CC*scH2015;
  F0125=AA*scH2125+BB*scH1125+CC*scH0125;
  F1025=AA*scH3025+BB*scH2025+CC*scH1025;

  F1115=AA*scH3115+BB*scH2115+CC*scH1115;
  ...
  // triple integrals required at that node
  F0013=AA*scH0213+BB*scH0113+CC*scH0013;
  F0103=AA*scH0303+BB*scH0203+CC*scH0103;
  F1003=AA*scH1203+BB*scH1103+CC*scH1003;

  F0015=AA*scH0215+BB*scH0115+CC*scH0015;
  F0105=AA*scH0305+BB*scH0205+CC*scH0105;
  F1005=AA*scH1205+BB*scH1105+CC*scH1005;
  F0215=AA*scH0415+BB*scH0315+CC*scH0215;
  F2015=AA*scH2215+BB*scH2115+CC*scH2015;
  F0125=AA*scH0325+BB*scH0225+CC*scH0125;
  F1025=AA*scH1225+BB*scH1125+CC*scH1025;
  F1115=AA*scH1315+BB*scH1215+CC*scH1115;
  ...
  BB=2.0q/Lq/Lq;
  CC=4.0q/Lp/Lq;
  DD=-4.0q*r1/Lp/Lp-3.0q/Lp-4.0q*s1/Lp/Lq;
  EE=-4.0q*s1/Lq/Lq-3.0q/Lq-4.0q*r1/Lp/Lq;
  FF=1.0q+4.0q*r1*s1/Lp/Lq+3.0q*r1/Lp+3.0q*s1/Lq+2.0q*r1*r1/Lp/Lp+2.0q*s1*s1/Lq/Lq;

  // triple integrals required at that node
  F0013=AA*scH2013+DD*scH1013+BB*scH0213+EE*scH0113+CC*scH1113+FF*scH0013;
  F0103=AA*scH2103+DD*scH1103+BB*scH0303+EE*scH0203+CC*scH1203+FF*scH0103;
  F1003=AA*scH3003+DD*scH2003+BB*scH1203+EE*scH1103+CC*scH2103+FF*scH1003;

  F0015=AA*scH2015+DD*scH1015+BB*scH0215+EE*scH0115+CC*scH1115+FF*scH0015;
  F0105=AA*scH2105+DD*scH1105+BB*scH0305+EE*scH0205+CC*scH1205+FF*scH0105;
  F1005=AA*scH3005+DD*scH2005+BB*scH1205+EE*scH1105+CC*scH2105+FF*scH1005;
  F0215=AA*scH2215+DD*scH1215+BB*scH0415+EE*scH0315+CC*scH1315+FF*scH0215;
  F2015=AA*scH4015+DD*scH3015+BB*scH2215+EE*scH2115+CC*scH3115+FF*scH2015;
  F0125=AA*scH2125+DD*scH1125+BB*scH0325+EE*scH0225+CC*scH1225+FF*scH0125;
  F1025=AA*scH3025+DD*scH2025+BB*scH1225+EE*scH1125+CC*scH2125+FF*scH1025;
  F1115=AA*scH3115+DD*scH2115+BB*scH1315+EE*scH1215+CC*scH2215+FF*scH1115;
  ...
  AA=-4.0q/Lp/Lp;
  BB=-4.0q/Lp/Lq;
  CC=4.0q/Lp+8.0*r1/Lp/Lp+4.0q*s1/Lp/Lq;
  DD=4.0q*r1/Lp/Lq;
  EE=-4.0q*r1/Lp-4.0q*r1*r1/Lp/Lp-4.0q*r1*s1/Lp/Lq;

  // triple integrals required at that node
  F0013=AA*scH2013+BB*scH1113+CC*scH1013+DD*scH0113+EE*scH0013;
  F0103=AA*scH2103+BB*scH1203+CC*scH1103+DD*scH0203+EE*scH0103;
  F1003=AA*scH3003+BB*scH2103+CC*scH2003+DD*scH1103+EE*scH1003;

  F0015=AA*scH2015+BB*scH1115+CC*scH1015+DD*scH0115+EE*scH0015;
  F0105=AA*scH2105+BB*scH1205+CC*scH1105+DD*scH0205+EE*scH0105;
  F1005=AA*scH3005+BB*scH2105+CC*scH2005+DD*scH1105+EE*scH1005;
  F0215=AA*scH2215+BB*scH1315+CC*scH1215+DD*scH0315+EE*scH0215;
  F2015=AA*scH4015+BB*scH3115+CC*scH3015+DD*scH2115+EE*scH2015;
  F0125=AA*scH2125+BB*scH1225+CC*scH1125+DD*scH0225+EE*scH0125;
  F1025=AA*scH3025+BB*scH2125+CC*scH2025+DD*scH1125+EE*scH1025;
  F1115=AA*scH3115+BB*scH2215+CC*scH2115+DD*scH1215+EE*scH1115;
  ...
  BB=-4.0q/Lp/Lq;
  CC=4.0q*s1/Lp/Lq;
  DD=4.0q/Lq+8.0*s1/Lq/Lq+4.0q*r1/Lp/Lq;
  EE=-4.0q*s1/Lq-4.0q*s1*s1/Lq/Lq-4.0q*r1*s1/Lp/Lq;

  // triple integrals required at that node
  F0013=AA*scH0213+BB*scH1113+CC*scH1013+DD*scH0113+EE*scH0013;
  F0103=AA*scH0303+BB*scH1203+CC*scH1103+DD*scH0203+EE*scH0103;
  F1003=AA*scH1203+BB*scH2103+CC*scH2003+DD*scH1103+EE*scH1003;

  F0015=AA*scH0215+BB*scH1115+CC*scH1015+DD*scH0115+EE*scH0015;
  F0105=AA*scH0305+BB*scH1205+CC*scH1105+DD*scH0205+EE*scH0105;
  F1005=AA*scH1205+BB*scH2105+CC*scH2005+DD*scH1105+EE*scH1005;
  F0215=AA*scH0415+BB*scH1315+CC*scH1215+DD*scH0315+EE*scH0215;
  F2015=AA*scH2215+BB*scH3115+CC*scH3015+DD*scH2115+EE*scH2015;
  F0125=AA*scH0325+BB*scH1225+CC*scH1125+DD*scH0225+EE*scH0125;
  F1025=AA*scH1225+BB*scH2125+CC*scH2025+DD*scH1125+EE*scH1025;
  F1115=AA*scH1315+BB*scH2215+CC*scH2115+DD*scH1215+EE*scH1115;
  ...
  // triple integrals required at that node
  F0013=BB*scH1113+CC*scH1013+DD*scH0113+EE*scH0013;
  F0103=BB*scH1203+CC*scH1103+DD*scH0203+EE*scH0103;
  F1003=BB*scH2103+CC*scH2003+DD*scH1103+EE*scH1003;

  F0015=BB*scH1115+CC*scH1015+DD*scH0115+EE*scH0015;
  F0105=BB*scH1205+CC*scH1105+DD*scH0205+EE*scH0105;
  F1005=BB*scH2105+CC*scH2005+DD*scH1105+EE*scH1005;
  F0215=BB*scH1315+CC*scH1215+DD*scH0315+EE*scH0215;
  F2015=BB*scH3115+CC*scH3015+DD*scH2115+EE*scH2015;
  F0125=BB*scH1225+CC*scH1125+DD*scH0225+EE*scH0125;
  F1025=BB*scH2125+CC*scH2025+DD*scH1125+EE*scH1025;
  F1115=BB*scH2215+CC*scH2115+DD*scH1215+EE*scH1115;
...
*/
  ...
  for(i=0;i<3;i++) { printf("%Qf\t", fx3[i]*10000.q); }; printf("\n");
  for(i=0;i<3;i++) { printf("%Qf\t", fx4[i]*10000.q); }; printf("\n");
  for(i=0;i<3;i++) { printf("%Qf\t", fx5[i]*10000.q); }; printf("\n");
  for(i=0;i<3;i++) { printf("%Qf\t", fx6[i]*10000.q); }; printf("\n");
  for(i=0;i<3;i++) { printf("%Qf\t", fx7[i]*10000.q); }; printf("\n");
  for(i=0;i<3;i++) { printf("%Qf\t", fx8[i]*10000.q); }; printf("\n");
