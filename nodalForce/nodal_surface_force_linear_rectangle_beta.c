...
void main_nodal_surface_force_linear_rectangle(double *x1, double *x2, double *x3, double *x4, double *x5, double *x6, double *b, double mu, double nu, double a, double *nodal_force[n_vertices], double *total_force){
  ...
  */
  ...
  double rot_centre[3], rot_x1[3], rot_x2[2];
  ...
  if(t_dot_n != 0.0){
    ...
    for (int i = 0; i < rotation; i++){
      ...
      printf("%f %f %f\n", rot_x1[0], rot_x1[1], rot_x1[2]);
      printf("%f %f %f\n", rot_x2[0], rot_x2[1], rot_x2[2]);
...
void mexFunction(int nlhs, mxArray *plhs[],
  ...
  fx[0] = (double *) mxGetPr(plhs[0]);
  fx[1] = (double *) mxGetPr(plhs[1]);
  fx[2] = (double *) mxGetPr(plhs[2]);
  fx[3] = (double *) mxGetPr(plhs[3]);
  ftot = (double *) mxGetPr(plhs[4]);

  main_nodal_surface_force_linear_rectangle(x1,x2,x3,x4,x5,x6,b,mu,nu,a,fx,ftot);
}
*/
