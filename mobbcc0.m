    ...
    for i=1:numNbrs
        ...
        if L>0.0
            ...
            linedir=rt./L;
             if abs(burgv(1)*burgv(2)*burgv(3))<eps
             ...
             else % i think it should L/2 not 2L !!
                cth2=(linedir*burgv')^2/(burgv*burgv'); % (lhat.bhat)^2 = cos^2(theta)                                              % calculate how close to screw the link is
                ...
                if ( 1 - cth2 ) >eps % not pure screw segment
                    ...
                    Bglide=1 / sqrt( 1 / Bedge^2 + ( 1 / Bscrew^2 - 1 / Bedge^2 ) * cth2); % Eqn (112) from Arsenlis et al 2007 MSMSE 15 553
