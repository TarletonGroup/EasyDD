function [output]=schematicplot2(rn,links,vertices,U_bar,Fend,amag,dx,totalSimTime)
figure(1);
clf
%amag=1;
...
elseif yind==3
 ...
 xlim([-1*vertices(xind2,xind) 2*vertices(xind2,xind)]*amag);
 ylim([-1*vertices(yind2,yind) 2*vertices(yind2,yind)]*amag);
