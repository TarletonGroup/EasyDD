function [rn,links,connectivity,linksinconnect,fseg,colliding_segments]=collision_basic_c(...
    ...
    if collision_condition_is_met
        ...
        if colliding_segments==1
            ...
            if mergednodeid>0
                ...
                [rn(:,4:6),~]=feval(mobility,fseg,rn,links,connectivity,mergednodeid,conlist);
            end
        end
    end
else
