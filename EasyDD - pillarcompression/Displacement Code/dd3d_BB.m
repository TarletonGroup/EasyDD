...
%     end
    ...
    %DDD+FEM coupling
    [uhat,fend,Ubar] = FEMcoupler_BB(rn,links,maxconnections,a,MU,NU,xnodes,mno,kg,L,U,...
...
%              end
    ...
    if (doremesh) %do virtual re-meshing first
        ...
        [rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew]=remesh_all_BB(rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew,lmin,lmax,areamin,areamax,MU,NU,a,Ec,mobility,doremesh,dovirtmesh,vertices,...
