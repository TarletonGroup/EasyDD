...
function [g,rn,links,connectivity,linksinconnect,fseg,Yh,Yc,Yo]=collisiontimer(rn,links,connectivity,linksinconnect,fseg,mindist,MU,NU,a,Ec,mobility,vertices,...
    uhat,nc,xnodes,D,mx,mz,w,h,d,g)
