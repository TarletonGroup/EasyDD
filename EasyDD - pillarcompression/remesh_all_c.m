...
function [rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew]=remesh_all_c(rn,links,connectivity,linksinconnect,fseg,lmin,lmax,areamin,areamax,MU,NU,a,Ec,mobility,doremesh,dovirtmesh,vertices,...
...
if (doremesh)
[rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew]=remesh_c(rnnew,linksnew,connectivitynew,linksinconnectnew,fsegnew,lmin,lmax,areamin,areamax,MU,NU,a,Ec,mobility,vertices,...
    uhat,nc,xnodes,D,mx,mz,w,h,d);
end
