...
rn=[         2*c   2.5*c+2*y           1.5*c   7;
           2*c+x   2.5*c+2*y         1.5*c-x   0;
         2*c+2*x   2.5*c+2*y       1.5*c-2*x   7;
       2*c+2*x+y       2.5*c     1.5*c-2*x+y   0;
     2*c+2*x+2*y   2.5*c-2*y   1.5*c-2*x+2*y   7;
       2*c+x+2*y   2.5*c-2*y     1.5*c-x+2*y   0;
         2*c+2*y   2.5*c-2*y       1.5*c+2*y   7;
           2*c+y       2.5*c         1.5*c+y   0];
