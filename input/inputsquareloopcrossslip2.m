...
rn = [2.5 * c + x - z 2.5 * c - y 0.5 * c + x + z 0;
    2.5 * c + 2 * x - z 2.5 * c - 2 * x - y 0.5 * c + 2 * x + z 0;
    2.5 * c + 2 * x + y - z 2.5 * c - 2 * x 0.5 * c + 2 * x + y + z 0;
    2.5 * c + 2 * x + y 2.5 * c - 2 * x 0.5 * c + 2 * x + y 0;
    2.5 * c + 2 * x + 2 * y 2.5 * c - 2 * x + y 0.5 * c + 2 * x + 2 * y 0;
    2.5 * c + x + 2 * y 2.5 * c + y 0.5 * c + x + 2 * y 0;
    2.5 * c + 2 * y 2.5 * c + 2 * x + y 0.5 * c + 2 * y 0;
    2.5 * c + y 2.5 * c + 2 * x 0.5 * c + y 0;
    2.5 * c + y - z 2.5 * c + 2 * x 0.5 * c + y + z 0;
    2.5 * c - z 2.5 * c + 2 * x - y 0.5 * c + z 0];
