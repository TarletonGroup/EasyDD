...
rn = [2 * c 2.5 * c + 2 * x - y 0.5 * c 0;
    2 * c + x 2.5 * c - y 0.5 * c + x 0;
    2 * c + 2 * x 2.5 * c - 2 * x - y 0.5 * c + 2 * x 0;
    2 * c + 2 * x + y 2.5 * c - 2 * x 0.5 * c + 2 * x + y 0;
    2 * c + 2 * x + 2 * y 2.5 * c - 2 * x + y 0.5 * c + 2 * x + 2 * y 0;
    2 * c + x + 2 * y 2.5 * c + y 0.5 * c + x + 2 * y 0;
    2 * c + 2 * y 2.5 * c + 2 * x + y 0.5 * c + 2 * y 0;
    2 * c + 2 * y + z 2.5 * c + 2 * x + y 0.5 * c + 2 * y - z 0;
    2 * c + y + z 2.5 * c + 2 * x 0.5 * c + y - z 0;
    2 * c + z 2.5 * c + 2 * x - y 0.5 * c - z 0];
