...
%without the first collision run with collisioncheckermex

function [rn,links,connectivity,linksinconnect,fseg]=collisionGPU(rn,links,connectivity,linksinconnect,fseg,mindist,MU,NU,a,Ec,mobility,vertices,...
