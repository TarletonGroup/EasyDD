function [rn,links] = cross_slip_BCCrotate5(fseg,rn,links,connectivity,~,...
                                            ~,curstep,~,NU,a,Ec,~,...
                                            uhat,nc,xnodes,D,mx,mz,w,h,d)
                      %Haihyang Yu's version was incompatible with everyone else's segforcevec.
                      % cross_slip_BCCrotate5(fseg,rn,links,connectivity,nodelist,conlist,curstep,MU,NU,a,Ec,linkid,appliedstress)
                   
                      

%[rn,links] = cross_slip_BCCrotate5(fseg,rn,links,connectivity,[],[],curstep,MU,NU,a,Ec,0,appliedstress);

global do_cross_slip rotationBCC do_reset last_step areamin L_cross_crit
if do_cross_slip==1 & curstep>1
                ...
                if numNbrs==2
                    ...
                    if (seg1_is_screw || seg2_is_screw || bothseg_are_screw)
                        ...
                        if (bothseg_are_screw) && (plane1 == plane2) &&...
                            ...
                            fsegtemp = segforcevec(MU,NU,a,Ec,rntemp,linkstemp,0,0,...
                                                   uhat,nc,xnodes,D,mx,mz,w,h,d);
                                      % This is Haiyang's segforcevec
                                      % function which is different to
                                      % everyone else'.                                         
                                      %segforcevec(MU,NU,a,Ec,rntemp,linkstemp,appliedstress,0,connectivity);
