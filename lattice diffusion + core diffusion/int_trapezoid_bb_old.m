function [rn,vn,dt, fseg]=int_trapezoid_bb_old(rn,dt,dt0,MU,NU,a,Ec,links,connectivity,...
...
[vnvec0,fseg] = drndt(rnvec0,flag,MU,NU,a,Ec,links,connectivity,...
        appliedstress,mobility,SimBox,xnodes,mno,wx,wy,wz,mx,my,mz,mel,nc,ke,Dv);
...
convergent=0;     %Logical for the operation of the while loop
    ...
    while(~convergent)
        ...
        [vnvec1,fseg] = drndt(rnvec1,flag,MU,NU,a,Ec,links,connectivity,...
        appliedstress,mobility,SimBox,xnodes,mno,wx,wy,wz,mx,my,mz,mel,nc,ke,Dv);
