...
zv = 1/sqrt(3);
z = zeros(8,3);
z(1,1:3) = rotationMatrix*[-zv,-zv,-zv]';
z(2,1:3) = rotationMatrix*[ zv,-zv,-zv]';
z(3,1:3) = rotationMatrix*[ zv, zv,-zv]';
z(4,1:3) = rotationMatrix*[-zv, zv,-zv]';
z(5,1:3) = rotationMatrix*[-zv,-zv, zv]';
z(6,1:3) = rotationMatrix*[ zv,-zv, zv]';
z(7,1:3) = rotationMatrix*[ zv, zv, zv]';
z(8,1:3) = rotationMatrix*[-zv, zv, zv]';
...
%rotate 45 degrees, so that 110 direction is x-coordinate.
for i=1:size(xnodes,1)
xnodes(i,:) = rotationMatrix*xnodes(i,:)';
end
   
nc = zeros(mel,4); %element connectivity, stays the same for 110 rotation
% 4. ----- .3
%  �\       �\
%  � \      � \
% 1. -\---- .2 \ 
